 ...
 */
@Deprecated(
    message = "Use @PublicDslProperty or @PrivateDslProperty instead.",
    replaceWith = ReplaceWith("PublicDslProperty", "org.khorum.oss.konstellation.metaDsl.annotation.PublicDslProperty")
)
